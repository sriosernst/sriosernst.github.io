...
createSequence(
  ...
  'Calcular una viga de hormigón', //Sequence title
  'Calcula la viga de hormigón necesaria en función de las dimensiones, los enlaces y las cargas introducidas', //Sequence info
  'stepando', //Sequence author
  'contact@stepando.com', //Sequence author email
  '0.1', //Sequence last version
  '28/12/2015', //Sequence last review date
...
addStep(
  ...
  'Select', //Step type
 ['Empotrado-Empotrado', 'Articulado-Empotrado', 'Articulado-Articulado', 'Voladizo'], //Step option
  'ancho', //Next step
...
//addStep methods creates new steps and adds them to the sequence
addStep(
  'ancho', //Step reference
  '¿Qué ancho tiene la viga?', //Step question
  'Input', //Step type
  'Float', //Step option
  'canto', //Next step
...
//addStep methods creates new steps and adds them to the sequence
addStep(
  'canto', //Step reference
  '¿Qué canto tiene la viga?', //Step question
  'Input', //Step type
  'Float', //Step option
...
addStep(
  ...
  'Ha de introducir una carga superficial en kN/m2 sin mayorar.</br>Más información en el siguiente <a href="sequences/static/vigahormigon/DBSE-AE_Peso_propio.pdf" target="_blank">enlace</a>.' //Step info
);
...
addStep(
  ...
  'Ha de introducir una carga superficial en kN/m2 sin mayorar.</br>Más información en el siguiente <a href="sequences/static/vigahormigon/DBSE-AE_Sobrecarga.pdf" target="_blank">enlace</a>.' //Step info
);
...
function sequenceResult() {
  ...
  var gammaY_PT = 1.50; // Coeficiente de minoración del acero para acciones persistentes o transitorias
  var gammaY_AS = 1.35; // Coeficiente de minoración del acero para acciones accidentales o sísmicas
  var gammaC_PT = 1.50; // Coeficiente de minoración del hormigón para acciones persistentes o transitorias
  var gammaC_AS = 1.35; // Coeficiente de minoración del hormigón para acciones accidentales o sísmicas
  var fck = 25000; // Resistencia característica del hormigón en KN/m2
  var fcd = fck / gammaC_PT; // Resistencia de cálculo del hormigón en KN/m2
  var fyk = 25000; // Resistencia característica del hormigón en KN/m2
  var fyd = fyk / gammaY_PT; // Resistencia de cálculo del hormigón en KN/m2
